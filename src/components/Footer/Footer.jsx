        ...
        <div className={style.content}>
          ...
          <address className={style.address}>
            <div className={style.contact}>
              ...
              <a className={style.phone} href='tel:+375298650535'>
                <svg
                  width='24'
                  height='24'
                  viewBox='0 0 24 24'
          ...
          <div className={style.development}>
            ...
            <p>
              Developer:{' '}
              <a href='mailto:maksim.leskin@methed.ru'>Anton Dashkevich</a>
            </p>
          </div>
        </div>
      </Container>
